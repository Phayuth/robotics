...
class MonoCalibrator:
    ...
    def do_calibration(opts, ipts, size, intrinsics_in, calib_flags):
        ...
        MonoCalibrator.set_alpha(0.0)

    def set_alpha(a, intrinsics, distortion, size, R, P):
        """
