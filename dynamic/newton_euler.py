...
def outward(T_i_ip1,
    ...
    R_i_ip1 = np.array([[T_i_ip1[0,0], T_i_ip1[0,1], T_i_ip1[0,2]],
                        [T_i_ip1[1,0], T_i_ip1[1,1], T_i_ip1[1,2]],
                        [T_i_ip1[2,0], T_i_ip1[2,1], T_i_ip1[2,2]]])
    R_ip1_i = R_i_ip1.T
    ...
    # v
    v_ip1_ip1 = R_ip1_i @ (v_i_i + np.cross(omega_i_i, p_i_ip1, axis=0)) # rotary joint       # v_ip1_ip1 = R_ip1_i @ (v_i_i + np.cross(omega_i_i, p_i_ip1, axis=0)) + ddot_ip1 @ Z_ip1_ip1 # prismatic joint
