# https://blog.tommycohn.com/2022/09/reimplementing-gcs-shortest-paths-in.html
...
tris = [
    ...
    [[1, 2], [3, 2], [2, 1]],
    [[1, 2], [3, 2], [2, 3]],
]  # South  # West  # North  # East  # Obstacle Bottom  # Obstacle Top
...
print(f"> gcs_regions: {gcs_regions}")
print(f"> region_points: {region_points}")
print(f"> gcs_regions_idx_dict: {gcs_regions_idx_dict}")
print(f"> conjugate_graph: {conjugate_graph}")
