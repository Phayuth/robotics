...
class RRTComponent:
    ...
    def __init__(self, baseConfigFile):
        # environment
        self.robotEnvClass = baseConfigFile["robotEnvClass"]()
        self.configLimit = self.robotEnvClass.configLimit
        self.configDoF = self.robotEnvClass.configDoF
        ...
        self.nearGoalRadius = baseConfigFile["nearGoalRadius"]
        ...
        # debug setting
        self.print_debug = baseConfigFile.get("print_debug", False)
    ...
    def is_config_in_collision(self, xCheck):
        ...
        result = self.robotEnvClass.collision_check(xCheck.config)
