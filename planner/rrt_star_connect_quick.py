...
class RRTStarConnectQuick(RRTComponent):
        ...
        for itera in range(self.maxIteration):
            ...
            if not self.is_collision_and_in_goal_region(xNearest, xNew, self.xGoal, self.distGoalToApp):
                ...
                if not self.is_collision_and_in_goal_region(xNearestPrime, xNewPrime, self.xGoal, self.distGoalToApp):
                    ...
                    self.star_quick_optimizer(Tb, xNewPrime, self.rewireRadius, xNewIsxRand=xNewPrimeIsxNew)
                    ...
                    while True:
                        ...
                        if self.distance_between_config(xNewPPrime, xNew) < 1e-3:
                            ...
                            self.star_quick_optimizer(Tb, xNewPPrime, self.rewireRadius, xNewPPrimeIsxNewPrime)
...
class RRTStarConnectQuickMulti(RRTComponent):
