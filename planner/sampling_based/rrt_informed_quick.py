...
class RRTInformedQuick(RRTComponent):
    ...
    def start(self):
        for itera in range(self.maxIteration):
            ...
            # rrtstar quick
            self.star_quick_optimizer(self.treeVertex, xNew, self.rewireRadius, xNewIsxRand, vertexDistList)
...
class RRTInformedQuickMulti(RRTComponent):
