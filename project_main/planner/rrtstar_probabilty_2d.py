...
class rrt_star():
    def __init__(self, x_init, x_goal, map, eta, w1, w2, max_interation):
        self.map = map
        self.eta = eta
        self.x_init = x_init
        self.x_goal = x_goal
    ...
    def Sampling(self): # bias sampling ?
    ...
    def Distance_cost(self, start, end): # euclidean distance
    ...
    def New_Check(self, x_new): # proposal 
        # print(x_new.arr)
    ...
    def start_planning(self):
        while True:
            ...
            self.sample_taken += 1
            if self.sample_taken%100 == 0:
                print(self.sample_taken,"Sample Taken")
