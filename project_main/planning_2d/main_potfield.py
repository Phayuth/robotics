...
from planner.potential_field import calc_potential_field, potential_field_planning
...
# potmap, minx, miny, maxx, maxy = calc_potential_field(map, gx, gy, robot_radius, sx, sy)
# # print(minx, miny, maxx, maxy)

# View map in 2d
# plt.imshow(potmap,origin='lower')
# plt.show()
