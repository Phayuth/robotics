...
for name in nameList:
    with open(f"./datasave/planner_performance/single2d/{name}_costgraph.pkl", "rb") as file:
...
nameList = ["multi_connect2d", "multi_connectlocgap2d", "multi_connectstar2d", "multi_connectstarlocgap2d"]

costGraphList = []
for name in nameList:
    with open(f"./datasave/planner_performance/multi2d/{name}_costgraph.pkl", "rb") as file:
        loadedList = pickle.load(file)
        costGraphList.append(loadedList)
