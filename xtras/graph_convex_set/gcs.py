...
obstacle = np.array([[2, 1], [3, 2], [2, 3], [1, 2]])
world_bounds = np.array([[0, 4], [0, 4]])
tris = [[[0, 0], [4, 0], [2, -1]], [[0, 0], [0, 4], [-1, 2]], [[0, 4], [4, 4], [2, 5]], [[4, 4], [4, 0], [5, 2]], [[1, 2], [3, 2], [2, 1]], [[1, 2], [3, 2], [2, 3]]]  # South  # West  # North  # East  # Obstacle Bottom  # Obstacle Top
