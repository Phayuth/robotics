...
def onestep_weight_correction(alpha, F, data, y, G, N, g, maxUpdate):
    for iter in range(maxUpdate):
    # for iter in range(1):
        print(iter)
...
# alpha, F = onestep_weight_correction(alpha, F, data, y, G, N, g, maxUpdate)
onestep_weight_correction(alpha, F, data, y, G, N, g, maxUpdate)
