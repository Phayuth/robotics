...
def draw_results(input_video_path, event_csv_path, output_video_path, configs, index_col="frame"):
    ...
    for i, axi in enumerate(axs):
        axi.plot(df.index, df[gait_events_list[i]], configs["event_colors"][i], linewidth=4.0)
        axi.set_ylim(0, 1.0)
